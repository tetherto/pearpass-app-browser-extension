...
Note: unlike the sibling desktop repo, this extension does **not** currently gate v1 vs v2 behind a `DESIGN_VERSION` / `isV2()` runtime flag. Kit-based components render directly at their call sites. If a flag is added later, this doc will describe it.
